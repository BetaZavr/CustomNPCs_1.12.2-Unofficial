...
implements ICustomElement {
	...
	public CustomTool(float attackDamageIn, float attackSpeedIn, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn, NBTTagCompound nbtItem) {
		...
		if (nbtItem.hasKey("EntityDamage", 6)) { this.attackDamage = (float) nbtItem.getDouble("EntityDamage"); }
		if (nbtItem.hasKey("HarvestLevel", 3)) { this.harvestLevel  = nbtItem.getInteger("HarvestLevel"); }
	...
	public int getHarvestLevel(ItemStack stack, String toolClass, @javax.annotation.Nullable net.minecraft.entity.player.EntityPlayer player, @javax.annotation.Nullable IBlockState blockState) {
		if (this.harvestLevel>-1) { return this.harvestLevel; }
