...
public class VisibilityController {
	...
	public static Map<String, EntityNPCInterface> trackedEntityHashTable = Maps
			.<String, EntityNPCInterface>newHashMap();
	public static Map<EntityPlayerMP, List<EntityNPCInterface>> invisibleNPCsTable = Maps
			.<EntityPlayerMP, List<EntityNPCInterface>>newHashMap();
