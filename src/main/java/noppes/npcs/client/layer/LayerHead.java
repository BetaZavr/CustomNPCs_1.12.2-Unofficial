...
public class LayerHead<T extends EntityLivingBase> extends LayerInterface<T> {
	...
	private void createParts() {
		...
		(this.beard = new Model2DRenderer((ModelBase) this.model, 56.0f, 20.0f, 8, 12)).setRotationOffset(-3.99f, 11.8f,
				-4.0f);
		this.beard.setScale(0.74f);
		(this.hair = new Model2DRenderer((ModelBase) this.model, 56.0f, 20.0f, 8, 12)).setRotationOffset(-3.99f, 11.8f,
				3.0f);
		this.hair.setScale(0.75f);
		(this.mohawk = new Model2DRenderer((ModelBase) this.model, 0.0f, 0.0f, 64, 64)).setRotationOffset(-9.0f, 0.1f,
				-0.5f);
