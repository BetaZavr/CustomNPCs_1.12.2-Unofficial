...
public class CustomModelSkinLegs extends ModelBiped {
	...
	private void renderAdvancedSkin(ISkin skin, Object renderData, EntityCustomNpc npc, Object advancedData,
			Object base) {
		try {
			ArmourersWorkshopUtil awu = ArmourersWorkshopUtil.getInstance();
