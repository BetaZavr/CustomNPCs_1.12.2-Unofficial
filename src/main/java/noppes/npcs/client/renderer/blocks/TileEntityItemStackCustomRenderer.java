...
public class TileEntityItemStackCustomRenderer
extends TileEntityItemStackRenderer {
	...
	public void renderByItem(ItemStack stack, float partialTicks) {
		...
		if (item == Items.SHIELD && stack.getSubCompound("BlockEntityTag") != null && stack.getTagCompound().getCompoundTag("BlockEntityTag").hasKey("FactionID")) {
