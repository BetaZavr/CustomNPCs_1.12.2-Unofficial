...
public class CustomGuiEditArrayEntries extends GuiEditArrayEntries {
	...
	public static class BaseEntry implements IArrayEntry {
		...
		public BaseEntry(GuiEditArray owningScreen, CustomGuiEditArrayEntries owningEntryList,
	...
	public static class BooleanEntry extends BaseEntry {
		...
		public BooleanEntry(GuiEditArray owningScreen, CustomGuiEditArrayEntries owningEntryList,
	...
	public static class ColorEntry extends BaseEntry {
		...
		public ColorEntry(GuiEditArray owningScreen, CustomGuiEditArrayEntries owningEntryList,
				IConfigElement configElement, String string) {
			super(owningScreen, owningEntryList, configElement);
			value = string;
	...
	public static class DoubleEntry extends StringEntry {
		...
		public DoubleEntry(GuiEditArray owningScreen, CustomGuiEditArrayEntries owningEntryList,
				IConfigElement configElement, Double value) {
	...
	public static class IntegerEntry extends StringEntry {
		...
		public IntegerEntry(GuiEditArray owningScreen, CustomGuiEditArrayEntries owningEntryList,
	...
	public static class StringEntry extends BaseEntry {
		...
		public StringEntry(GuiEditArray owningScreen, CustomGuiEditArrayEntries owningEntryList,
				IConfigElement configElement, Object value) {
			super(owningScreen, owningEntryList, configElement);
			this.textFieldValue = new GuiTextField(0, owningEntryList.getMC().fontRenderer,
					owningEntryList.width / 4 + 1, 0, owningEntryList.controlWidth - 3, 16);
	...
	public CustomGuiEditArrayEntries(GuiEditArray parent, Minecraft mc, IConfigElement configElement,
		...
		if (configElement.isList() && configElement.getArrayEntryClass() != null) {
			...
			for (Object value : currentValues) {
				listEntries.add(
						new DoubleEntry(this.owningGui, this, configElement, Double.parseDouble(value.toString())));
			}
		} else if (configElement.isList() && configElement.getType().equals(ConfigGuiType.COLOR)) {
			for (Object value : currentValues) {
				listEntries.add(new ColorEntry(this.owningGui, this, configElement, value.toString()));
			}
