...
implements IGuiData, ICustomScrollListener {
	...
	public void setGuiData(NBTTagCompound compound) {
		...
		for (int i = 0; i < nbtlist.tagCount(); ++i) {
			...
			String key = chr+"aID:"+nbt.getInteger("Id")+" "+chr+"r"+entity.getName()+" "+chr+"7"+this.df.format(distance);
			list.add(key);
	...
	@Override
	public void scrollDoubleClicked(String select, GuiCustomScroll scroll) { this.close(); }
