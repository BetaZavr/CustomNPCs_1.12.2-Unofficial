...
implements ISubGuiListener, ITextfieldListener {
	...
	public void initGui() {
		super.initGui();
		int x = 56, y = 50;
		this.addTextField(new GuiNpcTextField(1, this, this.fontRenderer, this.guiLeft + x, this.guiTop + y, 200, 20, this.job.song));
		...
		y += 30;
		this.addButton(new GuiNpcButton(2, this.guiLeft + x - 25, this.guiTop + y, 120, 20, new String [] {"bard.jukebox", "bard.background"}, this.job.isStreamer ? 0 : 1));
		this.addButton(new GuiNpcButton(3, this.guiLeft + x + 97, this.guiTop + y, 120, 20, new String [] { "bard.hasoff", "bard.hason" }, this.job.hasOffRange ? 0 : 1));
		this.addButton(new GuiNpcButton(4, this.guiLeft + x + 219, this.guiTop + y, 120, 20, new String [] { "type.range", "parameter.position" }, this.job.isRange ? 0 : 1));
		y += 30;
	...
	public void drawScreen(int i, int j, float f) {
		...
		if (this.getButton(0)!=null && this.getButton(0).isMouseOver()) {
			...
			this.setHoverText(new TextComponentTranslation("bard.hover.range."+this.getButton(2).getValue()).getFormattedText());
		} else if (this.getButton(3)!=null && this.getButton(3).isMouseOver()) {
			this.setHoverText(new TextComponentTranslation("bard.hover.dist."+this.getButton(3).getValue()).getFormattedText());
			...
			if (this.job.isRange) { this.setHoverText(new TextComponentTranslation("bard.hover.min").getFormattedText()); }
			else { this.setHoverText(new TextComponentTranslation("bard.hover.min").appendSibling(new TextComponentString("<br>")).appendSibling(new TextComponentTranslation("hover.scale.x")).getFormattedText()); }
		} else if (this.getTextField(3)!=null && this.getTextField(3).enabled && this.getTextField(3).isMouseOver()) {
			this.setHoverText(new TextComponentTranslation("bard.hover.min").appendSibling(new TextComponentString("<br>")).appendSibling(new TextComponentTranslation("hover.scale.y")).getFormattedText());
		} else if (this.getTextField(4)!=null && this.getTextField(4).enabled && this.getTextField(4).isMouseOver()) {
			this.setHoverText(new TextComponentTranslation("bard.hover.min").appendSibling(new TextComponentString("<br>")).appendSibling(new TextComponentTranslation("hover.scale.z")).getFormattedText());
		} else if (this.getTextField(5)!=null && this.getTextField(5).enabled && this.getTextField(5).isMouseOver()) {
			if (this.job.isRange) { this.setHoverText(new TextComponentTranslation("bard.hover.max").getFormattedText()); }
			else { this.setHoverText(new TextComponentTranslation("bard.hover.max").appendSibling(new TextComponentString("<br>")).appendSibling(new TextComponentTranslation("hover.scale.x")).getFormattedText()); }
	...
	public void unFocused(GuiNpcTextField textField) {
		switch(textField.getId()) {
			...
			case 2: {
				if (this.job.isRange) { this.job.range[0] = textField.getInteger(); }
				else { this.job.minPos[0] = textField.getInteger();}
				break;
			}
			case 3: {
			...
			case 5: {
				if (this.job.isRange) { this.job.range[1] = textField.getInteger(); }
				else { this.job.maxPos[0] = textField.getInteger();}
				break;
			}
			case 6: {
