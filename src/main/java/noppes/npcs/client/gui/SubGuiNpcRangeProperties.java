...
implements ITextfieldListener, ISubGuiListener {
	...
	public void initGui() {
		...
		y += 22;
		this.addTextField(
				new GuiNpcTextField(3, this, this.fontRenderer, j, y, 50, 18, this.ranged.getDelayMin() + ""));
		...
		y += 22;
		this.addTextField(new GuiNpcTextField(6, this, this.fontRenderer, this.guiLeft + 80, y, 50, 18,
				this.ranged.getBurst() + ""));
		...
		y += 22;
		this.addTextField(new GuiNpcTextField(7, this, this.fontRenderer, this.guiLeft + 80, y, 100, 20,
				this.ranged.getSound(0)));
		...
		y += 22;
		this.addTextField(new GuiNpcTextField(11, this, this.fontRenderer, this.guiLeft + 80, y, 100, 20,
				this.ranged.getSound(1)));
		...
		y += 22;
		this.addTextField(new GuiNpcTextField(10, this, this.fontRenderer, this.guiLeft + 80, y, 100, 20,
				this.ranged.getSound(2)));
