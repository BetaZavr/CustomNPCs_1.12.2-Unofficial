...
public class SubGuiNpcJobHealerSettings extends SubGuiInterface implements ITextfieldListener {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.getButton(1) != null && this.getButton(1).isMouseOver()) {
			...
			this.setHoverText(new TextComponentTranslation("beacon.hover.power",
					new TextComponentTranslation("enchantment.level." + p).getFormattedText()).getFormattedText());
	...
	public void initGui() {
		...
		this.addTextField(new GuiNpcTextField(1, this, this.fontRenderer, this.guiLeft + 123, this.guiTop + y, 45, 20,
				this.hs.range + ""));
		...
		this.addTextField(new GuiNpcTextField(2, this, this.fontRenderer, this.guiLeft + 123, this.guiTop + y, 45, 20,
				this.hs.speed + ""));
		...
		this.addTextField(new GuiNpcTextField(3, this, this.fontRenderer, this.guiLeft + 123, this.guiTop + y, 45, 20,
				(this.hs.amplifier + 1) + ""));
		...
		this.addTextField(new GuiNpcTextField(4, this, this.fontRenderer, this.guiLeft + 123, this.guiTop + y, 45, 20,
				this.hs.time + ""));
		...
		this.addButton(new GuiNpcButton(1, this.guiLeft + 88, this.guiTop + y, 80, 20,
				new String[] { "faction.friendly", "faction.unfriendly", "spawner.all" }, this.hs.type));
		y += 24;
	...
	public void unFocused(GuiNpcTextField textField) {
		...
		case 1: {
			this.hs.range = textField.getInteger();
			break;
		}
		case 2: {
			this.hs.speed = textField.getInteger();
			break;
		}
		case 3: {
			this.hs.amplifier = textField.getInteger() - 1;
			break;
		}
		case 4: {
			this.hs.time = textField.getInteger();
			break;
		}
		}
	}
