...
implements ITextfieldListener {
	...
	public void initGui() {
		...
		String text = AdditionalMethods.instance.deleteColor(new TextComponentTranslation("market.product").getFormattedText());
		...
		this.addButton(new GuiNpcButton(1, x + 100, y, 80, 20, new String[] { "gui.ignoreNBT.0", "gui.ignoreNBT.1" }, this.deal.getIgnoreNBT() ? 1 : 0));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		} else if (this.getTextField(2)!=null && this.getTextField(2).isMouseOver() || this.getTextField(3)!=null && this.getTextField(3).isMouseOver() || this.getTextField(4)!=null && this.getTextField(4).isMouseOver()) {
