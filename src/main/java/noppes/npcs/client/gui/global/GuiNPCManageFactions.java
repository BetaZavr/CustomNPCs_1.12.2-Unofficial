...
public class GuiNPCManageFactions extends GuiNPCInterface2
	...
	public void buttonEvent(GuiNpcButton button) {
		...
		case 6: {
			...
			this.setSubGui(new SubGuiNpcFactionSelect(6, this.scrollFactions.getSelected(), this.faction.attackFactions,
					corData));
			break;
		}
		case 7: {
			...
			this.setSubGui(new SubGuiNpcFactionSelect(7, this.scrollFactions.getSelected(), this.faction.frendFactions,
					corData));
			break;
		}
		case 8: { // description
	...
	public void drawScreen(int i, int j, float f) {
		...
		if (this.scrollFactions.getSelected() == null && this.faction.id > -1
				&& this.data.containsValue(this.faction.id)) {
		...
		if (this.getTextField(0) != null && this.getTextField(0).isMouseOver()) { // add new
			...
			this.setHoverText(new TextComponentTranslation("faction.hover.flag.get")
	...
	@Override
	public void save() {
		if (this.scrollFactions == null || this.scrollFactions.getSelected() == null
				|| !this.data.containsKey(this.scrollFactions.getSelected()) || this.faction == null
				|| this.faction.id == -1) {
			return;
		}
		NBTTagCompound compound = new NBTTagCompound();
	...
	public void unFocused(GuiNpcTextField textField) {
		...
		if (textField.getId() == 0) {
			...
			if (!name.isEmpty() && !this.data.containsKey(name)) {
				...
				String str = ((char) 167) + "7ID:" + this.faction.id + " " + ((char) 167) + "r"
						+ new TextComponentTranslation(name).getFormattedText();
