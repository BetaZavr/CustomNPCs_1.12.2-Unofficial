...
public class ModelTailFin extends ModelRenderer {
	...
	public ModelTailFin(ModelBiped base) {
		...
		this.setRotation(Shape1, -0.669215f, 0.0f);
		...
		this.setRotation(Shape2, -0.2602503f, 0.0f);
		...
		this.setRotation(Shape3, 0.0f, 1.07818f);
		...
		this.setRotation(Shape4, 0.0f, -1.003822f);
