...
public class ModelFeatherTail extends ModelRenderer {
	...
	final ModelRenderer feather1;
	final ModelRenderer feather2;
	final ModelRenderer feather3;
	final ModelRenderer feather4;
	final ModelRenderer feather5;

	public ModelFeatherTail(ModelBiped base) {
		super(base);
		int x = 56;
		int y = 16;
		(this.feather1 = new ModelRenderer(base, x, y)).addBox(-1.5f, 0.0f, 0.0f, 3, 8, 0);
		...
		(this.feather2 = new ModelRenderer(base, x, y)).addBox(-1.5f, 0.0f, 0.0f, 3, 8, 0);
		...
		(this.feather4 = new ModelRenderer(base, x, y)).addBox(-1.5f, 0.0f, 0.0f, 3, 8, 0);
