...
public class ModelMermaidLegs extends ModelRenderer {
	...
	public ModelMermaidLegs(ModelBase base) {
		...
		this.setRotation(this.bottom, 0.15f, 0.0f);
		...
		this.setRotation(this.fin1, 0.05f, 0.5911399f);
		...
		this.setRotation(this.fin2, 0.05f, -0.591143f);
	...
	private void setRotation(ModelRenderer model, float x, float z) {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
		...
		this.fin1.rotateAngleX = n;
		this.fin2.rotateAngleX = n;
	}
}
