...
{	
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		if (this.slot==null ||
			...
			if (this.slot!=null) { this.slot = null; }
			if (((ModelScaleRenderer) this.bipedHead).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedHead).displayOBJList = -1; }
			if (((ModelScaleRenderer) this.bipedHeadwear).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedHeadwear).displayOBJList = -1; }
			if (((ModelScaleRenderer) this.bipedBody).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedBody).displayOBJList = -1; }
			if (((ModelScaleRenderer) this.bipedLeftArm).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedLeftArm).displayOBJList = -1; }
			if (((ModelScaleRenderer) this.bipedRightArm).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedRightArm).displayOBJList = -1; }
			if (((ModelScaleRenderer) this.bipedLeftLeg).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedLeftLeg).displayOBJList = -1; }
			if (((ModelScaleRenderer) this.bipedRightLeg).displayOBJList > 0) { ((ModelScaleRenderer) this.bipedRightLeg).displayOBJList = -1; }
		} else {
