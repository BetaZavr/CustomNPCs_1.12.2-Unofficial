...
public class ImageDownloadAlt extends SimpleTexture {
	...
	public void loadTexture(IResourceManager resourceManager) throws IOException {
		...
		if (this.imageThread == null) {
			if (this.cacheFile != null && this.cacheFile.isFile()) {
				ImageDownloadAlt.logger.debug("Loading http texture from local cache ({})",
						new Object[] { this.cacheFile });
				try {
	...
	protected void loadTextureFromServer() {
		(this.imageThread = new Thread(
				"Texture Downloader #" + ImageDownloadAlt.threadDownloadCounter.incrementAndGet()) {
			// private static String __OBFID = "CL_00001050";
