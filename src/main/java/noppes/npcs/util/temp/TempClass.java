...
//System.out.println("Enum: "+api.getSimpleName());
...
//System.out.println("Class: "+api.getSimpleName());
...
System.out.println("Save Forge names: "+new File(dir, "forge_names.lang"));
	...
	public static String getLoc(String loc) {
		...
		//System.out.println("Not found localisation: \""+loc+"\"");
		return loc;
	}
	...
	private static void saveFile(File file, String text) {
		try {
			...
			//System.out.println("Save: "+file.getParentFile().getName()+"/"+file.getName());
		} catch (Exception e) { }
	}
...
System.out.println("Total keys: "+lang.size()+"; en: "+enMap.size()+"; ru: "+ruMap.size());
...
System.out.println("Total java Files: \""+TempClass.javaFiles.size()+"\"");
		for (File f : TempClass.javaFiles) {
			try {
