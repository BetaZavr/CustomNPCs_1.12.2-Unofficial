...
public enum EnumInterfaceData {
	...
	IAttributeModifier(new InterfaseData(IAttributeModifier.class, 
			null,
			new Class<?>[] { AttributeModifierWrapper.class },
			"interfase.iattributemodifier", 
			new MethodData(String.class, "getName", "method.iattributemodifier.getname"),
			new MethodData(IAttributeModifier.class, "setName", "method.iattributemodifier.setname",
				new ParameterData(String.class, "name", "parameter.iattributemodifier.name")
			),
			new MethodData(String.class, "getID", "method.iattributemodifier.getid"),
			new MethodData(IAttributeModifier.class, "setAmount", "method.iattributemodifier.setamount",
				new ParameterData(double.class, "amount", "parameter.iattributemodifier.amount")
			),
	...
	INpcAttribute(new InterfaseData(INpcAttribute.class, 
			null,
			new Class<?>[] { AttributeWrapper.class },
			"interfase.inpcattribute", 
	...
	IScriptHandler(new InterfaseData(IScriptHandler.class, 
			...
			new MethodData(void.class, "runScript", "method.iscripthandler.runscript",
				new ParameterData(String.class, "type", "parameter.iscripthandler.type"),
