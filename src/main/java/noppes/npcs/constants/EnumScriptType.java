																																									...
																																									"levelUp"), QUEST_START(
																																											"questStart"), QUEST_COMPLETED(
																																													"questCompleted"), QUEST_TURNIN(
																																															"questTurnIn"), KEY_UP(
																																																	"keyPressed"), KEY_GUI_UP(
																																																			"keyGUIPressed"), CUSTOM_CHEST_CLOSED(
																																																											...
																																																											"customGuiClosed"), CUSTOM_GUI_BUTTON(
																																																													"customGuiButton"), CUSTOM_GUI_SLOT(
																																																															"customGuiSlot"), CUSTOM_GUI_SCROLL(
																																																																	"customGuiScroll"), CUSTOM_GUI_SLOT_CLICKED(
																																																																			"customGuiSlotClicked"), QUEST_CANCELED(
																																																																					"questCanceled"), ITEM_FISHED(
																																																																							"itemFished"), ITEM_CRAFTED(
																																																																									"itemCrafted"), KEY_DOWN(
																																																																											"keyDown"), MOUSE_DOWN(
																																																																													"mouseDown"), MOUSE_UP(
																																																																															"mousePressed"), POTION_IS_READY(
																																																																																	"isReady"), POTION_PERFORM(
																																																																																			"performEffect"), POTION_AFFECT(
																																																																																					"affectEntity"), PLASED(
																																																																																							"plased"), POTION_END(
																																																																																									"endEffect"), SCRIPT_TRIGGER(
																																																																																											"trigger"), SOUND_PLAY(
																																																																																													"soundPlayed"), SOUND_STOP(
																																																																																															"soundStoped"), PACKEGE_RECEIVED(
																																																																																																	"packageReceived"), PACKEGE_FROM(
																																																																																																			"packageFrom"), CUSTOM_TELEPORT(
																																																																																																					"customTeleport"), KEY_ACTIVE(
																																																																																																							"keyActive"), STOP_ANIMATION(
																																																																																																									"stopAnimation"), GUI_OPEN(
																																																																																																											"openGUI"), SOUND_TICK_EVENT(
																																																																																																													"soundTickEvent"), QUEST_LOG_BUTTON(
																																																																																																															"questLogButton"), EXTRA_BUTTON(
																																																																																																																	"questButton");
