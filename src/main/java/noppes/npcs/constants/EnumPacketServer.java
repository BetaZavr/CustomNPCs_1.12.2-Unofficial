...
public enum EnumPacketServer
{
	...
	TraderMarketSave(CustomNpcsPermissions.GLOBAL_MARKET, false),
	TraderMarketGet(CustomNpcsPermissions.GLOBAL_MARKET, false),
	TraderMarketDel(CustomNpcsPermissions.GLOBAL_MARKET, false),
	...
	NbtBookSaveEntity(CustomNpcsPermissions.TOOL_NBT_BOOK),
	NbtBookSaveItem(CustomNpcsPermissions.TOOL_NBT_BOOK),
	NbtBookSaveBlock(CustomNpcsPermissions.TOOL_NBT_BOOK),
