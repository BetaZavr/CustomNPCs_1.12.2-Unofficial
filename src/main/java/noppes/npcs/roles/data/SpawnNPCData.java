...
public class SpawnNPCData {
	...
	public SpawnNPCData(NBTTagCompound nbt) {
	...
	public String getTitle() {
		...
		if (this.compound != null) { // client or server clone
			if (this.typeClones == 1 && this.compound.hasKey("id", 8)) { // mob
				Entity entity = EntityList.createEntityByIDFromName(new ResourceLocation(this.compound.getString("id")),
	...
	public void readFromNBT(NBTTagCompound nbt) {
		if (nbt.hasKey("EntityNBT", 10)) {
			this.compound = nbt.getCompoundTag("EntityNBT");
		}
